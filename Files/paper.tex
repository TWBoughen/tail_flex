...
regard to the tail behaviour of the limiting degree distribution. The
limiting survival if the proposed GPA model is:
...
corresponding thresholds are shown with short vertical lines towards the
top of each plot.}
