...
::: {#rem-omega}
If $b(k)\rightarrow <\infty$, then $\Omega(F, k) = 0$.
:::

::: {#cor-omega2}
Let $\bar F (k)$ bet he limiting survival function of degree in a GPA network with preference function $b$ such that $b(k)\rightarrow\infty$. Then:
